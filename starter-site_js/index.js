...
app.post('/translate_upload', upload, async (req, res) => {
 ...
 const process_text = async (endpoint, data) => {
  ...
  /* use async await to call the analyze text api with image data */
...
const process_text_final_response = async (response_headers) => {
  ...
  if('status' in result && result.status == 'failed'){
    ...
    console.log("RETURN RESULT: ", word_list)
  ...
  /* use async await to post to translation end point with the words that needs to be translated
...
app.post('/translate_url', async (req, res) => {
  ...
  /*
  write a async function that calls the OCR api and Extract text from images API (OCR)
...
/*
make async API call to translation end point with the words extrated from the OCR api
  await response
*/
